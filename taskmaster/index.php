    ...
    <table class="table">
        ...
        <?php else: ?>
            <?php foreach ($tarefas as $t): ?>
                <tr>
                    <td><?= htmlspecialchars($t['titulo']) ?><div class="desc"><?= nl2br(htmlspecialchars($t['descricao'])) ?></div></td>
                    ...
                    <td class="actions">
                        ...
                        <a class="btn small danger" href="excluir.php?id=<?= $t['id'] ?>" onclick="return confirm('Excluir essa tarefa?');">Excluir</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        <?php endif; ?>
